import"./index-Mw9DRhCZ.js";/* empty css                *//* empty css                  *//* empty css                 *//* empty css                   */import{a8 as _,a5 as f,R as g,z as E,E as l}from"./element-BgteM3iW.js";import{t as y,v as w,M as n,E as c,J as u,x as h}from"./vue-BMMZpZdF.js";import{_ as x}from"./plugin-vue_export-helper-DlAUqK2U.js";import"./vxe-DZA90d05.js";const A={lock:!0,text:"Loading..."},p=(t,e={})=>{let r;return async(...a)=>{try{return r=_.service({...A,...e}),await t(...a)}finally{r.close()}}},S={code:0,data:{list:[]},message:"Request successful"};function C(t){return new Promise(e=>{setTimeout(()=>{e({...S,data:{list:t}})},1e3)})}function v(){return new Promise((t,e)=>{setTimeout(()=>{e(new Error("An error occurred"))},1e3)})}const k={class:"app-container"},L=`
  <path class="path" d="
    M 30 15
    L 28 17
    M 25.61 25.61
